...
public sealed class FloatSetting : CustomSetting
{
    ...
    public override void CreateSettingUi(SettingsTabController settingsTabController)
    {
        ...
        SliderSettingBehaviour.SetSetting(this);
    ...
    public override void UiUpdate()
    {
        ...
        SliderSettingBehaviour.slider.interactable = isEditable;
        SliderSettingBehaviour.decrementButton.interactable = isEditable;
        SliderSettingBehaviour.incrementButton.interactable = isEditable;
        if (isEditable)
        {
