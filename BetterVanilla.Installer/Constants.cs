...
public static class Constants
{
    ...
    public const string BepInExVersionFilename = "BepInExVersion.json";
    public const string BepInExConfigFilename = "BepInEx.cfg";
    public const uint SteamAppId = 945360;
}
